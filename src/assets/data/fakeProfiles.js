    ...
    socialLinks: [
      {
        ...
        href: 'https://facebook.com/' + generate_username,
        label: 'Facebook',
      },
      {
        icon: 'fab fa-twitter',
        href: 'https://twitter.com/' + generate_username,
        label: 'Twitter',
      },
      {
        icon: 'fab fa-linkedin',
        href: 'https://in.linkedin.com/in/' + generate_username,
        label: 'LinkedIn',
      },
      {
        icon: 'fab fa-github',
        href: 'https://github.com/' + generate_username,
        label: 'GitHub',
      },
    ],
  });
